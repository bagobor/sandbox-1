...
void TriangulateDelaunay2(const Vec2* points, uint32_t numPoints, const Vec2* bpoints, uint32_t numBPoints, std::vector<Vec2>& outPoints, std::vector<uint32_t>& outTris);
